...
void TetrahedronEdgeFromEdgeModelDerivative<DoubleType>::derived_init()
{
  ...
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(x_ModelName1, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(x_ModelName2, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(x_ModelName3, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(y_ModelName0, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(y_ModelName1, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(y_ModelName2, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(y_ModelName3, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(z_ModelName0, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
  dsModelFactory<TetrahedronEdgeSubModel<DoubleType>>::create(z_ModelName1, rp, TetrahedronEdgeModel::DisplayType::NODISPLAY, this->GetSelfPtr());
