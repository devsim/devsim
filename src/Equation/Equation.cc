...
void Equation<DoubleType>::NodeAssembleRHS(
    dsMath::RHSEntryVec<DoubleType> &v, const NodeScalarData<DoubleType> &nrhs)
{
...
template <typename DoubleType>
std::string Equation<DoubleType>::GetDerivativeModelName(
    const std::string &model, const std::string &var)
{
