...
void Equation<DoubleType>::Update(NodeModel &nm,
                                  const std::vector<DoubleType> &rhs) {
  UpdateValues(nm, rhs);
}

template <typename DoubleType>
void Equation<DoubleType>::ACUpdate(
    NodeModel &nm, const std::vector<std::complex<DoubleType>> &rhs) {
...
void Equation<DoubleType>::NoiseUpdate(
    ...
    const std::vector<std::complex<DoubleType>> &rhs) {
...
void Equation<DoubleType>::DefaultUpdate(
    NodeModel &nm, const std::vector<DoubleType> &result) {
  const Region &reg = *myregion;
...
void Equation<DoubleType>::DefaultACUpdate(
    NodeModel &nm, const std::vector<std::complex<DoubleType>> &result) {
...
void Equation<DoubleType>::DefaultNoiseUpdate(
    ...
    const std::vector<std::complex<DoubleType>> &result) {
