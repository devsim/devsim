...
void ProcessAreaAndNormal(size_t ni0, std::vector<DoubleType> &nv,
                          ...
                          const Vector<DoubleType> &vnormal, DoubleType volume)
{
  nv[ni0] += volume;
...
void processTriangle(const Triangle &triangle,
                     ...
                     std::vector<DoubleType> &nv, std::vector<DoubleType> &nvx,
                     std::vector<DoubleType> &nvy, std::vector<DoubleType> &nvz)
{
...
template void processTriangleList<>(
    ConstTriangleList &triangle_list,
    const std::vector<Vector<double>> &triangleCenters, std::vector<double> &nv,
    std::vector<double> &nvx, std::vector<double> &nvy,
    std::vector<double> &nvz);
}  // namespace SurfaceAreaUtil
