...
class TriangleElementField {
 ...
 private:
  ...
  const EdgePairVectors_t &GetEdgePairVectors(
      const Triangle &, const std::vector<DoubleType> &) const;
  const DerivativeEdgePairVectors_t &GetDerivativeEdgePairVectors(
      const Triangle &, const std::vector<DoubleType> &,
