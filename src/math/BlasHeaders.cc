...
typedef void(daxpy_signature)(int *n, double *alpha, double *dx, int *incx,
                              double *dy, int *incy);
typedef void(dcopy_signature)(int *n, double *dx, int *incx, double *dy,
                              int *incy);
typedef void(dgemm_signature)(char *transa, char *transb, int *m, int *n,
                              int *k, double *alpha, double *a, int *lda,
                              double *b, int *ldb, double *beta, double *c,
                              int *ldc);
typedef void(dgemv_signature)(char *trans, int *m, int *n, double *alpha,
                              double *a, int *lda, double *x, int *incx,
                              double *beta, double *y, int *incy);
typedef double(dnrm2_signature)(int *n, double *dx, int *incx);
typedef void(dtrsm_signature)(char *side, char *uplo, char *transa, char *diag,
                              int *m, int *n, double *alpha, double *a,
                              int *lda, double *b, int *ldb);
typedef void(dtrsv_signature)(char *uplo, char *trans, char *diag, int *n,
                              double *a, int *lda, double *x, int *incx);
typedef void(dswap_signature)(int *n, double *dx, int *incx, double *dy,
                              int *incy);
...
typedef void(zaxpy_signature)(int *n, doublecomplex *alpha, doublecomplex *dx,
                              int *incx, doublecomplex *dy, int *incy);
typedef void(zcopy_signature)(int *n, doublecomplex *dx, int *incx,
                              doublecomplex *dy, int *incy);
typedef void(zgemm_signature)(char *transa, char *transb, int *m, int *n,
                              int *k, doublecomplex *alpha, doublecomplex *a,
                              int *lda, doublecomplex *b, int *ldb,
                              doublecomplex *beta, doublecomplex *c, int *ldc);
typedef void(zgemv_signature)(char *trans, int *m, int *n, doublecomplex *alpha,
                              doublecomplex *a, int *lda, doublecomplex *x,
                              int *incx, doublecomplex *beta, doublecomplex *y,
                              int *incy);
typedef void(zswap_signature)(int *n, doublecomplex *dx, int *incx,
                              doublecomplex *dy, int *incy);
typedef void(ztrsm_signature)(char *side, char *uplo, char *transa, char *diag,
                              int *m, int *n, doublecomplex *alpha,
                              doublecomplex *a, int *lda, doublecomplex *b,
                              int *ldb);
typedef void(ztrsv_signature)(char *uplo, char *trans, char *diag, int *n,
                              doublecomplex *a, int *lda, doublecomplex *x,
                              int *incx);
...
void external_dtrsv(char *a, char *b, char *c, int *d, double *e, int *f,
                    double *g, int *h) {
...
void external_daxpy(int *n, double *alpha, double *dx, int *incx, double *dy,
                    int *incy) {
...
void external_dgemm(char *transa, char *transb, int *m, int *n, int *k,
                    double *alpha, double *a, int *lda, double *b, int *ldb,
                    double *beta, double *c, int *ldc) {
  blas_table::dgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c,
                    ldc);
}

void external_dgemv(char *trans, int *m, int *n, double *alpha, double *a,
                    int *lda, double *x, int *incx, double *beta, double *y,
                    int *incy) {
  blas_table::dgemv(trans, m, n, alpha, a, lda, x, incx, beta, y, incy);
}

void external_dtrsm(char *side, char *uplo, char *transa, char *diag, int *m,
...
void external_zaxpy(int *n, doublecomplex *alpha, doublecomplex *dx, int *incx,
                    doublecomplex *dy, int *incy) {
  blas_table::zaxpy(n, alpha, dx, incx, dy, incy);
}

void external_zcopy(int *n, doublecomplex *dx, int *incx, doublecomplex *dy,
                    int *incy) {
  blas_table::zcopy(n, dx, incx, dy, incy);
}

void external_zgemm(char *transa, char *transb, int *m, int *n, int *k,
                    doublecomplex *alpha, doublecomplex *a, int *lda,
                    doublecomplex *b, int *ldb, doublecomplex *beta,
                    doublecomplex *c, int *ldc) {
  blas_table::zgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c,
                    ldc);
}

void external_zgemv(char *trans, int *m, int *n, doublecomplex *alpha,
...
void external_zswap(int *n, doublecomplex *dx, int *incx, doublecomplex *dy,
                    int *incy) {
  blas_table::zswap(n, dx, incx, dy, incy);
}

void external_ztrsm(char *side, char *uplo, char *transa, char *diag, int *m,
                    int *n, doublecomplex *alpha, doublecomplex *a, int *lda,
                    doublecomplex *b, int *ldb) {
  blas_table::ztrsm(side, uplo, transa, diag, m, n, alpha, a, lda, b, ldb);
}

void external_ztrsv(char *uplo, char *trans, char *diag, int *n,
                    doublecomplex *a, int *lda, doublecomplex *x, int *incx) {
  ...
  for (auto &entry : math_function_table) {
    ...
    if (h) {
      *entry.function_pointer = h;
      //      std::cerr << "DEBUG " << entry.symbol_name << " " << h <<
      //      std::endl;
    }
#if 0
    else
...
LoaderMessages_t LoadMathLibraries(std::string &errors) {
  ...
  if (ret == LoaderMessages_t::NO_ENVIRONMENT) {
    ...
    errors += "Not attempting to load Intel MKL since DEVSIM_MATH_LIBS is "
              "specified.\n";
  }
  return ret;
}
