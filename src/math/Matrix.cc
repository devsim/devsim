...
template <typename DoubleType>
DoubleVec_t<DoubleType> Matrix<DoubleType>::operator*(
    const DoubleVec_t<DoubleType> &x) const
{
...
template <typename DoubleType>
ComplexDoubleVec_t<DoubleType> Matrix<DoubleType>::operator*(
    const ComplexDoubleVec_t<DoubleType> &x) const
{
