...
std::string FormatContactEquationOnContactName(
    const Region & /*region*/, const Contact & /*contact*/,
    const std::string & /*equation_name*/);
std::string FormatInterfaceEquationOnInterfaceName(
    const Region & /*region*/, const Interface & /*interface*/,
    const std::string & /*equation_name*/);
}  // namespace dsErrors
#endif
