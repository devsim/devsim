...
// Geometry Commands
const char get_device_list_doc[] = "get_device_list\n";
const char get_region_list_doc[] = "get_region_list\n";
const char get_interface_list_doc[] = "get_interface_list\n";
const char get_contact_list_doc[] = "get_contact_list\n";
// Material Commands
const char set_parameter_doc[] = "set_parameter\n";
const char get_parameter_doc[] = "get_parameter\n";
const char get_parameter_list_doc[] = "get_parameter_list\n";
const char set_material_doc[] = "set_material\n";
const char get_material_doc[] = "get_material\n";
const char create_db_doc[] = "create_db\n";
const char open_db_doc[] = "open_db\n";
const char close_db_doc[] = "close_db\n";
const char save_db_doc[] = "save_db\n";
const char add_db_entry_doc[] = "add_db_entry\n";
const char get_db_entry_doc[] = "get_db_entry\n";
const char get_dimension_doc[] = "get_dimension\n";
// Model Commands
const char contact_edge_model_doc[] = "contact_edge_model\n";
const char contact_node_model_doc[] = "contact_node_model\n";
const char debug_triangle_models_doc[] = "debug_triangle_models\n";
const char delete_edge_model_doc[] = "delete_edge_model\n";
const char delete_element_model_doc[] = "delete_element_model\n";
const char delete_interface_model_doc[] = "delete_interface_model\n";
const char delete_node_model_doc[] = "delete_node_model\n";
const char edge_from_node_model_doc[] = "edge_from_node_model\n";
const char edge_average_model_doc[] = "edge_average_model\n";
const char edge_model_doc[] = "edge_model\n";
const char element_from_edge_model_doc[] = "element_from_edge_model\n";
const char element_from_node_model_doc[] = "element_from_node_model\n";
const char vector_element_model_doc[] = "vector_element_model\n";
const char element_model_doc[] = "element_model\n";
const char get_edge_model_list_doc[] = "get_edge_model_list\n";
const char get_edge_model_values_doc[] = "get_edge_model_values\n";
const char get_element_model_list_doc[] = "get_element_model_list\n";
const char get_element_model_values_doc[] = "get_element_model_values\n";
const char get_interface_model_list_doc[] = "get_interface_model_list\n";
const char get_interface_model_values_doc[] = "get_interface_model_values\n";
const char get_node_model_list_doc[] = "get_node_model_list\n";
const char get_node_model_values_doc[] = "get_node_model_values\n";
const char interface_model_doc[] = "interface_model\n";
const char interface_normal_model_doc[] = "interface_normal_model\n";
const char node_model_doc[] = "node_model\n";
const char node_solution_doc[] = "node_solution\n";
const char print_edge_values_doc[] = "print_edge_values\n";
const char print_element_values_doc[] = "print_element_values\n";
const char print_node_values_doc[] = "print_node_values\n";
const char register_function_doc[] = "register_function\n";
const char set_node_values_doc[] = "set_node_values\n";
const char set_node_value_doc[] = "set_node_value\n";
const char symdiff_doc[] = "symdiff\n";
const char vector_gradient_doc[] = "vector_gradient\n";
const char cylindrical_edge_couple_doc[] = "cylindrical_edge_couple\n";
const char cylindrical_node_volume_doc[] = "cylindrical_node_volume\n";
const char cylindrical_surface_area_doc[] = "cylindrical_surface_area\n";
// Math Commands
const char get_contact_current_doc[] = "get_contact_current\n";
const char get_contact_charge_doc[] = "get_contact_charge\n";
const char solve_doc[] = "solve\n";
// Equation Commands
const char equation_doc[] = "equation\n";
const char interface_equation_doc[] = "interface_equation\n";
const char contact_equation_doc[] = "contact_equation\n";
const char custom_equation_doc[] = "custom_equation\n";
const char get_equation_numbers_doc[] = "get_equation_numbers\n";
const char get_equation_list_doc[] = "get_equation_list\n";
const char get_interface_equation_list_doc[] = "get_interface_equation_list\n";
const char get_contact_equation_list_doc[] = "get_contact_equation_list\n";
const char delete_equation_doc[] = "delete_equation\n";
const char delete_interface_equation_doc[] = "delete_interface_equation\n";
const char delete_contact_equation_doc[] = "delete_contact_equation\n";
const char get_equation_command_doc[] = "get_equation_command\n";
const char get_contact_equation_command_doc[] = "get_contact_equation_command\n";
const char get_interface_equation_command_doc[] = "get_interface_equation_command\n";
// Meshing Commands
const char create_1d_mesh_doc[] = "create_1d_mesh\n";
const char finalize_mesh_doc[] = "finalize_mesh\n";
const char add_1d_mesh_line_doc[] = "add_1d_mesh_line\n";
const char add_1d_interface_doc[] = "add_1d_interface\n";
const char add_1d_contact_doc[] = "add_1d_contact\n";
const char add_1d_region_doc[] = "add_1d_region\n";
const char create_2d_mesh_doc[] = "create_2d_mesh\n";
const char add_2d_mesh_line_doc[] = "add_2d_mesh_line\n";
const char add_2d_region_doc[] = "add_2d_region\n";
const char add_2d_interface_doc[] = "add_2d_interface\n";
const char add_2d_contact_doc[] = "add_2d_contact\n";
const char create_device_doc[] = "create_device\n";
const char load_devices_doc[] = "load_devices\n";
const char write_devices_doc[] = "write_devices\n";
const char create_gmsh_mesh_doc[] = "create_gmsh_mesh\n";
const char add_gmsh_contact_doc[] = "add_gmsh_contact\n";
const char add_gmsh_interface_doc[] = "add_gmsh_interface\n";
const char add_gmsh_region_doc[] = "add_gmsh_region\n";
const char create_genius_mesh_doc[] = "create_genius_mesh\n";
const char add_genius_contact_doc[] = "add_genius_contact\n";
const char add_genius_interface_doc[] = "add_genius_interface\n";
const char add_genius_region_doc[] = "add_genius_region\n";
const char create_contact_from_interface_doc[] = "create_contact_from_interface\n";
// Circuit Commands
const char add_circuit_node_doc[] = "add_circuit_node\n";
const char circuit_element_doc[] = "circuit_element\n";
const char circuit_alter_doc[] = "circuit_alter\n";
const char circuit_node_alias_doc[] = "circuit_node_alias\n";
const char get_circuit_node_list_doc[] = "get_circuit_node_list\n";
const char get_circuit_solution_list_doc[] = "get_circuit_solution_list\n";
const char get_circuit_node_value_doc[] = "get_circuit_node_value\n";
const char set_circuit_node_value_doc[] = "set_circuit_node_value\n";
const char get_circuit_equation_number_doc[] = "get_circuit_equation_number\n";
