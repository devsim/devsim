...
void writeDevicesCmd(CommandHandler &data)
{
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"type", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"include_test", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
  bool error = data.processOptions(option, errorString);
  ...
  if (data.IsSpecified("include_test"))
  {
    ...
    {
      errorString +=
          R"(Option "include_test" only supported when "type" is "vtk" or "tecplot".)"
          "\n";
      data.SetErrorResult(errorString);
      return;
    }
