...
add_gmsh_contact   -mesh mos2d -gmsh_name "drain_contact"  -region "bulk" -name "drain"
add_gmsh_contact   -mesh mos2d -gmsh_name "source_contact" -region "bulk" -name "source"
add_gmsh_contact   -mesh mos2d -gmsh_name "body_contact"   -region "bulk" -name "body"
add_gmsh_contact   -mesh mos2d -gmsh_name "gate_contact"   -region "gate" -name "gate"
...
write_devices -file gmsh_mos2d_out.flps -type floops
