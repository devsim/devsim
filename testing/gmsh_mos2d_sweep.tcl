...
write_devices -file "gmsh_mos2d_1.0_0.0" -type vtk
...
write_devices -file "gmsh_mos2d_2.0_0.0" -type vtk

for {set v 0.01} {$v < 0.41} {set v [expr $v + 0.01]} {
puts "\n\nsetting $v\n\n"
set_parameter -device $device -region bulk -name "drainbias" -value $v
solve -type dc -absolute_error 1e30 -relative_error 1e-10 -maximum_iterations 200
...
#write_devices -file "gmsh_mos2d_0.5_0.4.flps" -type floops
write_devices -file "gmsh_mos2d_2.0_0.4" -type vtk
