...
add_1d_mesh_line -mesh dog -pos 0 -ps 5e-7 -tag top
add_1d_mesh_line -mesh dog -pos 1e-5 -ps 5e-7 -tag bot
...
vector_gradient -device $device -region $region -node_model V1.I_ElectronContinuityEquation_real -calc_type avoidzero
...
set rv "V1.I_ElectronContinuityEquation_real_gradx"
set iv "V1.I_ElectronContinuityEquation_imag_gradx"
...
print_node_values -device $device -region $region -name noise
