...
create_gmsh_mesh -file gmsh_diode3d.msh -mesh diode3d
...
solve -type dc -absolute_error 1.0 -relative_error 1e-12 -maximum_iterations 30 -solver_type iterative
...
solve -type dc -absolute_error 1e10 -relative_error 1e-10 -maximum_iterations 30 -solver_type iterative
...
puts [format "ElementNodeVolume %1.15e" [expr 2 *[sum [get_element_model_values -device $device -region $region -name "ElementNodeVolume"]]]]
puts [format "NodeVolume %1.15e" [sum [get_node_model_values -device $device -region $region -name "NodeVolume"]]]


write_devices -file gmsh_resistor3d.dat -type tecplot
