...
source dio2_element_physics.tcl
#####
# dio1
#
...
proc createMesh {device region} {
    ...
    add_2d_contact   -mesh dog -name top -region $region -yl 0.8e-5 -yh 1e-5 -xl 0 -xh 0 -bloat 1e-10
...
write_devices -file dio2_element_2d_potentialonly.flps -type floops
...
write_devices -file dio2_element_2d_dd.flps -type floops
write_devices -file dio2_element_2d_dd -type vtk
