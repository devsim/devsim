...
set -e
apt-get update
apt-get install -y git curl make cmake gcc g++ flex bison tcl8.5 tcl8.5-dev tcl-dev python2.7 python2.7-dev sqlite3 libsqlite3-dev zlib1g-dev libblas3 liblapack3
...
bash scripts/setup_ubuntu_16.04.sh
